...
public class BookmarksManagerDataContextFactory : IDesignTimeDbContextFactory<BookmarksManagerDataContext>
{
    public BookmarksManagerDataContext CreateDbContext(string[] args)
    {
        var config = new ConfigurationBuilder()
           .SetBasePath(Path.Combine(Directory.GetCurrentDirectory(), 
           $"..{Path.DirectorySeparatorChar}ReactBookmarksManager.Web"))
